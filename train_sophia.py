...
data_dir = os.path.join('/lus/eagle/projects/datascience/mngom/data/sophia_theta/', dataset) #os.path.join('data', dataset)
def get_batch(split):
...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  ...
                  mup_output_alpha=mup_output_alpha, mup_base_head = mup_base_head) # start with model_args from command line
...
# optimizer
optimizer = model.configure_optimizers(optimizer_name, weight_decay, learning_rate, (beta1, beta2), device_type,rho)
if init_from == 'resume':
